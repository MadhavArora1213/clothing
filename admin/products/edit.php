        ...
        <div class="admin-card-section">
          ...
          <div style="display: flex; flex-direction: column; gap: 12px;">
            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
              <input type="checkbox" name="free_shipping" value="1" <?= ($product['free_shipping'] ?? 1) ? 'checked' : '' ?>>
              <span style="font-size: 13px; font-weight: 500;">Free Shipping for this product</span>
            </label>

            <div id="shippingChargeGroup" style="display: <?= ($product['free_shipping'] ?? 1) ? 'none' : 'block' ?>;">
              <div class="form-group" style="margin: 0;">
                <label style="font-size: 11px;">Shipping Charge (₹)</label>
                <input type="number" step="0.01" min="0" name="shipping_charge" placeholder="0" value="<?= $product['shipping_charge'] ?? 0 ?>">
              </div>
