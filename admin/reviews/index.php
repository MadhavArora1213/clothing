...
<div class="admin-content">
  ...
  <?php if (!empty($_GET['msg'])): ?>
    <div style="margin-bottom: 20px; background: #DCFCE7; color: #166534; border: 1px solid #BBF7D0; padding: 12px 16px; border-radius: 8px; font-size: 13px; font-weight: 500;">
      <?= sanitize($_GET['msg']) ?>
    </div>
  <?php endif; ?>
