...
.aura-footer .footer-col h4 { color: #000 !important; }
.aura-footer .footer-links a { color: rgba(255,255,255,0.5) !important; }
.aura-footer .footer-links a:hover { color: #000 !important; }
...
.aura-footer .footer-bottom-links a:hover { color: #000 !important; }
...
<section class="ct-main">
  ...
  <div class="ct-right">
    <div class="ct-img-area">
      <div class="ct-imgs">
        <img class="ct-img-main" src="../images/menhero1.png" alt="Urban Outfit Collection">
        <img class="ct-img-sm" src="../images/womenhero1.png" alt="Urban Outfit Collection">
    ...
    <div class="ct-info-strip">
      <div class="ct-info-item">
        ...
        <h4>Email</h4>
        <p>support@urbanoutfitshop.com</p>
      </div>
      <div class="ct-info-item">
        ...
        <h4>Phone</h4>
        <p>+91 97807 04131</p>
        <a href="tel:+919780704131">Call Now</a>
      </div>
      <div class="ct-info-item">
        ...
        <h4>Visit Us</h4>
        <p>Opp. Sri Guru Nanak Girls Senior Secondary School, Mukerian, Punjab 144211</p>
...
<!-- WhatsApp FAB -->
<a href="https://wa.me/919780704131" target="_blank" class="ct-wa">
